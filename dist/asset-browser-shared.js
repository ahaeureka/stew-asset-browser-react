...
export function LoadingOverlay({ title = 'Loading assets', message = 'Fetching collection, versions, and the resource tree. Please wait.', }) {
...
function LoadingSpinner() {
    return (React.createElement("svg", { width: "42", height: "42", viewBox: "0 0 42 42", fill: "none", "aria-hidden": "true" },
        React.createElement("circle", { cx: "21", cy: "21", r: "16", stroke: "var(--stew-ab-accent-soft, rgba(14, 165, 233, 0.18))", strokeWidth: "4" }),
        React.createElement("path", { d: "M21 5C29.8366 5 37 12.1634 37 21", stroke: "var(--stew-ab-accent, #0ea5e9)", strokeWidth: "4", strokeLinecap: "round" },
            React.createElement("animateTransform", { attributeName: "transform", type: "rotate", from: "0 21 21", to: "360 21 21", dur: "0.9s", repeatCount: "indefinite" }))));
}
